...
class KeyChain {
    ...
    func addItem(account:String,password:String) throws -> Void {
        let query: [String: AnyObject] = [
            ...
            kSecAttrService as String: service.data(using: .utf8)! as AnyObject,
            kSecAttrAccount as String: account.data(using: .utf8)! as AnyObject,
    ...
    func getItem(account:String) throws -> String {
        let query: [String: AnyObject] = [
            // kSecAttrService,  kSecAttrAccount, and kSecClass
    ...
    func delItem(account:String) throws -> Void {
        let query: [String: AnyObject] = [
                // kSecAttrService,  kSecAttrAccount, and kSecClass
